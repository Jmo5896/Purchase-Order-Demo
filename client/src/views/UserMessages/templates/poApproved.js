...
import icon from './../../../imgs/orderApproved-icon.svg'
import './templates.css'

export default function PoApproved(props) {
  const bodyStyle = {
    display: 'flex',
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Click <Link to="/poflow/dashboard/myhistory">here</Link>, to view and print your
          purchase order.
        </h2> */}
        <Link to="/poflow/dashboard/myhistory">
