module.exports = (info, body) => {
  return {
    subject: body
      ? `${body.rejectionEmail} purchase order has been rejected.`
    ...
    <div aria-live="assertive" aria-atomic="true">
      <div class="email-frame">
        ...
        <h3>The reason for rejection is :</h3>
        <div
          style="
          ...
          "
        >
          <p>${body.reason || 'No reason was given.'}</p>
        </div>
        <p class="footer-p">
    ...
    <div aria-live="assertive" aria-atomic="true">
      <div class="email-frame">
        ...
        <img
          ...
          src="https://files.dcschools.us/dcschools/client/src/imgs/logo192.png"
        />
        <h2 class="main-title">Your purchase order has been rejected</h2>
        <div
          style="
            /* background-color: #0e4b0e44; */
            /* background-color: rgb(179, 178, 178); */
        ...
        <button class="detail-button">
          View or Edit Your Rejected Order
        </button>
        </a>
